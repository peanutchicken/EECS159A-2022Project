...
HD_PWD='C:/Users/Kyl3Z/OneDrive/Documents/GitHub/EECS159A-2022Project/senior_design/senior_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log safety_circuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source safety_circuit.tcl
